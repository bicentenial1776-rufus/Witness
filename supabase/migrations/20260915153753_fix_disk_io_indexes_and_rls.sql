...
--
-- Applied directly to production on 2026-09-15 and captured here after the
-- fact to close the gap between the database and this migration history
-- (see 20260915200000_individual_events_tree_id_id_index.sql for the
-- follow-up: this migration's new individual_events_tree_id_idx wasn't
-- enough on its own -- the planner kept preferring the primary key scan).
