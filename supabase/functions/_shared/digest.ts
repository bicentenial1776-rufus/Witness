// Ported from packages/core/src/query/digest.ts for Deno (keep the two in
// sync when editorial rules change). The client is typed structurally —
// any supabase-js client satisfies it.
// deno-lint-ignore no-explicit-any
type WitnessSupabaseClient = any;
