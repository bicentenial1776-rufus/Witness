# Witness — Phase 1 Marketing Task List (Weeks 1–6, $0 Budget)

Goal: build organic momentum toward 100 paid subscribers by Dec 31, 2026.
Owner tags: **[Rufus]** = requires you personally (relationships, judgment calls, on-camera). **[Claude]** = I draft/research/build, you review and approve before anything goes out.
...
- [ ] **[Claude]** Draft personalized pitch emails to the top 5 podcasters/YouTubers from Week 2's list, using the founder-story press kit.
- [ ] **[Rufus]** Review, personalize, and send — these land better coming from you directly.
- [ ] **[Rufus]** Post approved Facebook group content (from Week 2 drafts) now that memberships are approved.
- [ ] **[Claude]** Set up a simple weekly tracker (source → replies → trial starts → conversions) so we can see what's working before Phase 2 spend decisions.

## Week 4 — Produce demo content

- [ ] **[Claude]** Script 3 short "story reveal" video concepts (per the earlier flag: test story-reveal against UI-demo format for genealogy audiences).
- [ ] **[Rufus]** Record the hand-demo clips.
- [ ] **[Claude]** Write captions/hooks for TikTok and Instagram Reels versions of each clip.
- [ ] **[Rufus]** Post 1 clip, gauge response before batching the rest.
- [ ] **[Rufus]** Follow up with any Week 3 podcast/YouTube contacts who haven't replied (2-week non-responder threshold, same pattern as the society campaign).

## Week 5 — ProductHunt prep

- [ ] **[Claude]** Draft the ProductHunt listing (tagline, description, first-comment story) — needs your voice, not a generic template.
- [ ] **[Rufus]** Line up 3–5 people (testers, warm society contacts) willing to comment/upvote at launch — PH's algorithm rewards early genuine engagement.
- [ ] **[Claude]** Prepare a short FAQ doc anticipating PH community questions (data privacy is usually the first one for a genealogy app).

## Week 6 — Launch and review

- [ ] **[Rufus]** Launch on ProductHunt (pick a Tuesday–Thursday, per PH norms).
- [ ] **[Rufus]** Personally respond to every PH comment same-day.
- [ ] **[Claude]** Pull the 6-week tracker data: trial starts, conversions, and reply rates by source.
- [ ] **[Rufus + Claude]** Decide together which 1–2 channels earned the modest paid budget for Phase 2 — don't split it across everything that "sort of worked."
