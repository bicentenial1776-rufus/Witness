...
const DEMO_TIMELINE: { to: number; scrollMs: number; holdMs: number }[] = [
  { to: 1.0, scrollMs: 0, holdMs: 45500 }, // base: intro + the Pulse
  { to: 0.77, scrollMs: 3000, holdMs: 38500 }, // gens 1–2: slots/doubling, filled vs empty
  { to: 0.55, scrollMs: 3000, holdMs: 39000 }, // mid gens: verified, eras
  { to: 0.3, scrollMs: 3000, holdMs: 61000 }, // gen 6: walls, beacons + collapse, brief
  { to: 0.0, scrollMs: 4000, holdMs: 27000 }, // summit + golden thread
  { to: 1.0, scrollMs: 5000, holdMs: 29500 }, // return to base: recap + the research loop
];
